...
import {
  ...
  IMG_ROOM_POKÓJ, IMG_ROOM_SALON, IMG_ROOM_SYPIALNIA, IMG_ROOM_HOL, IMG_ROOM_PODDASZE,
  IMG_WIN_1, IMG_WIN_2, IMG_WIN_3, IMG_WIN_LEWE, IMG_WIN_PRAWE,
  IMG_WIN_TARASOWE, IMG_WIN_BALKONOWE, IMG_WIN_KUCHENNE,
  JZ, JZALUZJA_MOTORS, JZALUZJA_REMOTES, JZ_LABELS, JZ_ZONES,
  KN, KP, KSLIM, KUNIV,
...
export function ModalRoom(p){
  ...
  return ce("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:999,padding:"16px"}},
    ce("div",{style:{background:"var(--bg)",borderRadius:18,padding:"1.6rem",width:520,maxWidth:"96vw",border:"1px solid var(--bd2)",boxShadow:"0 16px 48px rgba(0,0,0,0.18)"}},
      ...
      ce("div",{style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:14}},
        ROOM_PRESETS.map(function(preset){
          ...
          return ce("div",{
            ...
            preset.img
              ?ce("img",{src:preset.img,style:{width:64,height:64,objectFit:"cover",borderRadius:10},onError:function(e){e.target.style.display="none";}})
              :ce("div",{style:{width:64,height:64,borderRadius:10,background:"var(--bg2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26,color:"var(--t2)"}},"+"),
...
export function ModalWindow(p){
  ...
  return ce("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:999,padding:"16px"}},
    ce("div",{style:{background:"var(--bg)",borderRadius:18,padding:"1.6rem",width:560,maxWidth:"96vw",border:"1px solid var(--bd2)",boxShadow:"0 16px 48px rgba(0,0,0,0.18)"}},
      ...
      ce("div",{style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10,marginBottom:14}},
        WIN_PRESETS.map(function(preset){
          ...
          return ce("div",{
            ...
            preset.img
              ?ce("img",{src:preset.img,style:{width:60,height:60,objectFit:"cover",borderRadius:8},onError:function(e){e.target.style.display="none";}})
              :ce("div",{style:{width:60,height:60,borderRadius:8,background:"var(--bg2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,color:"var(--t2)"}},"+"),
            ce("div",{style:{fontSize:11,fontWeight:600,color:isActive?"var(--t1)":"var(--t2)",textAlign:"center",lineHeight:1.2}},preset.label)
          );
        })
      ),
